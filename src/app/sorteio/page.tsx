...
export default function SorteioPage() {
  ...
  // Sorteio Equilibrado - Estratégia em 2 Fases (chamando função importada)
  // Nota: A redefinição aqui era necessária antes, mas agora usamos a função importada
  // que implementa a estratégia correta: EXTREMOS para todos, MEIO para completos
